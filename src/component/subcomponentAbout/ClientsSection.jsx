...
function ClientsSection() {
  ...
  return (
    ...
    <div className="clients-section">
      ...
      {selectedClient && (
        <ModalPortal onClose={() => setSelectedClient(null)} theme="light">
          <div className="ab-modal-overlay" onClick={() => setSelectedClient(null)} role="dialog" aria-modal="true" aria-label={selectedClient.client_name}>
