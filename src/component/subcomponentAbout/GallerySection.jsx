...
function GallerySection() {
  ...
  return (
    <div className="sectionAboutFour">
      ...
      {/* Modal — unchanged */}
      {selectedItem && (
        <ModalPortal onClose={() => setSelectedItem(null)}>
          <div className="modal-overlay" onClick={() => setSelectedItem(null)} role="dialog" aria-modal="true" aria-label={selectedItem.title}>
